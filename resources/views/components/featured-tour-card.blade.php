...
<article class="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden flex flex-col">
    ...
    <div class="p-4 flex-1 flex flex-col">
        ...
        <p class="text-sm font-semibold text-emerald-700 mb-3">
            From USD {{ number_format($tour->base_price_adult) }} per adult
        </p>
        <a href="{{ route('tours.show', [$location, $tour]) }}" class="mt-auto inline-flex items-center justify-center px-4 py-2 rounded-full bg-emerald-600 text-white text-xs font-semibold hover:bg-emerald-700">
            View details & book
        </a>
    </div>
</article>

    ...
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center gap-2">
            ...
            @if($tour->share_token && $tour->isShareLinkValid())
                <button type="button" @click="shareLink.copyShareUrl('{{ $tour->share_url }}')" class="inline-flex items-center gap-2 px-4 py-2 bg-green-600 text-white rounded-lg text-sm font-medium hover:bg-green-700 cursor-pointer">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            @else
                <button type="button" @click="shareLink.generateShareLink({{ $tour->id }})" class="inline-flex items-center gap-2 px-4 py-2 bg-green-600 text-white rounded-lg text-sm font-medium hover:bg-green-700 cursor-pointer">
                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        Alpine.data('shareLinkManager', () => ({
            ...
            async copyShareUrl(url) {
                try {
                    ...
                    toastr.error('Failed to copy link. Please copy manually: ' + url);
                }
            },
        }));
    });

...
<div class="max-w-4xl">
    ...
    <form method="POST" action="{{ route('console.tours.update', $tour) }}" class="space-y-6">
        @csrf
        @method('PUT')
        ...
        <div class="bg-white rounded-xl shadow-sm border border-slate-200">
            ...
            <div class="p-6 space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="title" id="title" value="{{ old('title', $tour->title) }}" class="w-full rounded-lg border-slate-300 text-sm focus:border-emerald-500 focus:ring-emerald-500" required>
                    @error('title')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <textarea name="short_description" id="short_description" rows="2" maxlength="300" class="w-full rounded-lg border-slate-300 text-sm focus:border-emerald-500 focus:ring-emerald-500">{{ old('short_description', $tour->short_description) }}</textarea>
                ...
                <div>
                    ...
                    <textarea name="description" id="description" rows="6" class="w-full rounded-lg border-slate-300 text-sm focus:border-emerald-500 focus:ring-emerald-500">{{ old('description', $tour->description) }}</textarea>
                    @error('description')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="p-6 space-y-6">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="text" name="duration_text" id="duration_text" value="{{ old('duration_text', $tour->duration_text) }}" placeholder="e.g. 4 hours" class="w-full rounded-lg border-slate-300 text-sm focus:border-emerald-500 focus:ring-emerald-500">
                        @error('duration_text')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                    <div>
                        ...
                        <input type="time" name="starts_at_time" id="starts_at_time" value="{{ old('starts_at_time', $tour->starts_at_time) }}" class="w-full rounded-lg border-slate-300 text-sm focus:border-emerald-500 focus:ring-emerald-500">
                    ...
                    <div>
                        ...
                        <input type="text" name="meeting_point" id="meeting_point" value="{{ old('meeting_point', $tour->meeting_point) }}" class="w-full rounded-lg border-slate-300 text-sm focus:border-emerald-500 focus:ring-emerald-500">
                        @error('meeting_point')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div>
                    ...
                    <textarea name="includes" id="includes" rows="4" class="w-full rounded-lg border-slate-300 text-sm focus:border-emerald-500 focus:ring-emerald-500" placeholder="List what's included in the tour...">{{ old('includes', $tour->includes) }}</textarea>
                    @error('includes')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <textarea name="important_information" id="important_information" rows="4" class="w-full rounded-lg border-slate-300 text-sm focus:border-emerald-500 focus:ring-emerald-500" placeholder="Any important notes for travelers...">{{ old('important_information', $tour->important_information) }}</textarea>
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div>
                        ...
                        <input type="number" name="base_price_adult" id="base_price_adult" value="{{ old('base_price_adult', $tour->base_price_adult) }}" min="0" step="1" class="w-full rounded-lg border-slate-300 text-sm focus:border-emerald-500 focus:ring-emerald-500" required>
                    ...
                    <div>
                        ...
                        <input type="number" name="base_price_child" id="base_price_child" value="{{ old('base_price_child', $tour->base_price_child ?? 0) }}" min="0" step="1" class="w-full rounded-lg border-slate-300 text-sm focus:border-emerald-500 focus:ring-emerald-500">
                    ...
                    <div>
                        ...
                        <input type="number" name="base_price_infant" id="base_price_infant" value="{{ old('base_price_infant', $tour->base_price_infant ?? 0) }}" min="0" step="1" class="w-full rounded-lg border-slate-300 text-sm focus:border-emerald-500 focus:ring-emerald-500">
            ...
            <div class="p-6 space-y-4">
                ...
                <div class="pt-4">
                    ...
                    <select name="status" id="status" class="w-full md:w-48 rounded-lg border-slate-300 text-sm focus:border-emerald-500 focus:ring-emerald-500" required>
                        <option value="draft" {{ old('status', $tour->status) === 'draft' ? 'selected' : '' }}>Draft</option>
                        <option value="published" {{ old('status', $tour->status) === 'published' ? 'selected' : '' }}>Published</option>
                    </select>
                    @error('status')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
        ...
        <div class="flex items-center gap-4">
            ...
            <a href="{{ route('console.tours.show', $tour) }}" class="px-6 py-2 bg-slate-100 text-slate-700 rounded-lg text-sm font-medium hover:bg-slate-200">
                Cancel
            </a>
        </div>
    </form>

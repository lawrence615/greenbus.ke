                    ...
                    <tr class="hover:bg-emerald-50/50 transition-colors duration-150 group">
                        <td class="px-4 py-3">
                            <div class="flex items-center gap-3">
                                ...
                                <div class="min-w-0">
                                    ...
                                    <a href="{{ $tour->admin_show_route }}" class="block font-semibold text-slate-900 hover:text-emerald-600 transition-colors truncate max-w-[200px] lg:max-w-[350px]" title="{{ $tour->title }}">
                                        {{ $tour->title }}
                                    </a>
                        ...
                        <td class="px-4 py-3 text-right">
                            <div class="flex items-center justify-end gap-0.5">
                                <a href="{{ $tour->admin_show_route }}" class="p-1.5 text-slate-500 hover:text-slate-700 hover:bg-slate-100 rounded-lg transition-colors duration-150" title="View">
                                    <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">

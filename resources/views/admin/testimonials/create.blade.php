...
<div class="max-w-3xl">
    ...
    <form method="POST" action="{{ route('console.testimonials.store') }}" class="space-y-6">
        @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="space-y-1.5">
                    <label for="author_location" class="flex items-center gap-1.5 text-sm font-medium text-slate-700">
                        ...
                        <span class="relative group">
                            ...
                            <span class="absolute left-1/2 -translate-x-1/2 bottom-full mb-2 px-2 py-1 text-xs text-white bg-slate-800 rounded whitespace-nowrap opacity-0 group-hover:opacity-100 transition-opacity z-10">Customer's country or city</span>
                        </span>
                    </label>
                    <input 
                        type="text" 
                ...
                <div class="space-y-1.5">
                    ...
                    >
                        ...
                        <option value="Solo traveller" {{ old('travel_type') === 'Solo traveller' ? 'selected' : '' }}>Solo traveller</option>
                        <option value="Couple" {{ old('travel_type') === 'Couple' ? 'selected' : '' }}>Couple</option>
                        <option value="Family with children" {{ old('travel_type') === 'Family with children' ? 'selected' : '' }}>Family with children</option>
                        <option value="Friends group" {{ old('travel_type') === 'Friends group' ? 'selected' : '' }}>Friends group</option>
                        <option value="Business traveller" {{ old('travel_type') === 'Business traveller' ? 'selected' : '' }}>Business traveller</option>
                        <option value="Local guest" {{ old('travel_type') === 'Local guest' ? 'selected' : '' }}>Local guest</option>
                    </select>
                    @error('travel_type')
                    <p class="text-xs text-red-500">{{ $message }}</p>
                    @enderror

...
class TourSeeder extends Seeder
{
    public function run(): void
    {
        ...
        if (! Tour::where('city_id', $nairobi->id)->exists()) {
            ...
            $cityTourImages = [
                ['tour_id' => $museumMarket->id,'path'=>'greenbus/images/NRB-001/nairobi-historic-and-modern-highlights-city-walking-tour-0WZHDvLy.jpg', 'is_cover' => false, 'sort_order' => 1],
                ['tour_id' => $museumMarket->id,'path'=>'greenbus/images/NRB-001/nairobi-historic-and-modern-highlights-city-walking-tour-mLrZtq7e.jpg', 'is_cover' => false, 'sort_order' => 2],
                ['tour_id' => $museumMarket->id,'path'=>'greenbus/images/NRB-001/nairobi-historic-and-modern-highlights-city-walking-tour-ArbtClKd.jpg', 'is_cover' => false, 'sort_order' => 3],
                ['tour_id' => $museumMarket->id,'path'=>'greenbus/images/NRB-001/nairobi-historic-and-modern-highlights-city-walking-tour-IVG5NskM.jpg', 'is_cover' => false, 'sort_order' => 4],
                ['tour_id' => $museumMarket->id,'path'=>'greenbus/images/NRB-001/nairobi-historic-and-modern-highlights-city-walking-tour-HLAhl0U5.jpg', 'is_cover' => false, 'sort_order' => 5],
                ['tour_id' => $museumMarket->id,'path'=>'greenbus/images/NRB-001/nairobi-historic-and-modern-highlights-city-walking-tour-fbScbiiW.jpg', 'is_cover' => false, 'sort_order' => 6],
            ];
            ...
            $cityHighlightsItems = [
                ['type' => 'start', 'time_label' => '10:00 AM', 'title' => 'Kencom / City Square – Meet your guide', 'description' => "Meet your guide at a central pickup point in Nairobi, get a short briefing about the route and what to expect.", 'sort_order' => 1],
                ['type' => 'activity', 'time_label' => '10:30 AM', 'title' => 'Kenyatta Avenue & CBD – City walk', 'description' => "Walk past key landmarks in the city centre while your guide shares stories about Nairobi's history and everyday life.", 'sort_order' => 2],
                ...
                ['type' => 'activity', 'time_label' => '12:00 PM', 'title' => 'City Market or craft area – Market walk', 'description' => 'Explore a local market or craft area to see how people shop and work, with time for questions and optional browsing.', 'sort_order' => 4],
            ...
            $museumMarketItems = [
                ...
                ['type' => 'activity','time_label' => '11:30 AM', 'title' => 'Transfer to city markets', 'description' => 'Travel with your guide from the museum area to the city markets.', 'sort_order' => 4],
                ['type' => 'activity','time_label' => '12:00 PM', 'title' => 'City markets – Guided walk', 'description' => 'Walk through one or more central markets to see everyday shopping, fruits, vegetables and local products.', 'sort_order' => 5],
